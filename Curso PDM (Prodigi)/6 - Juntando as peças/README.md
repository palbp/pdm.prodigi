...
- Compreender os princípios que regem o desenho de aplicações Android que atuam como clientes de Web APIs.
    ...
    - Usar eficazmente o modelo de concorrência baseado em corrotinas para a realização de operações de rede assíncronas.
- Integrar todos os conceitos aprendidos ao longo do curso numa aplicação Android completa.
    - Arquitetura MVVM com Jetpack Compose.
    - Desenho da UI com fluxo de dados reativo.
